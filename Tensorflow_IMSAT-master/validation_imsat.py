# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 00:07:43 2021
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(n_epoch):
            ...
            for it in range(test_train_epoch_num):
                ...
                _, ploss, ploss1, ploss2 = sess.run([train_op, loss, loss1, loss2], feed_dict={unlabeled_x: samples, is_training: True, learning_rate: lr})
                sum_loss = sum_loss + ploss
                sum_conditional_entropy = sum_conditional_entropy + ploss1
                sum_rsat = sum_rsat + ploss2
                print('TRAINING LOSSS: %7.4f, conditional entropy: %7.4f, vat loss: %7.4f' %
                  (sum_loss/total_iterations_train, sum_conditional_entropy/total_iterations_train, sum_rsat/total_iterations_train))
            ...
            for it in range(test_test_epoch_num):
                ...
                sum_conditional_entropy = sum_conditional_entropy + ploss1
                sum_rsat = sum_rsat + ploss2
                print('VALIDATION LOSSS: %7.4f, conditional entropy: %7.4f, vat loss: %7.4f' %
                  (sum_loss/total_iterations_train, sum_conditional_entropy/total_iterations_train, sum_rsat/total_iterations_train))
