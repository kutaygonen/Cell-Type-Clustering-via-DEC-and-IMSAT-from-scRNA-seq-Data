# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 00:08:27 2021
...
train1_data, test_data, train1_data_labels, test_data_labels = train_test_split(data_sq, df, test_size=0.33, random_state=1)
train_data, valitadion_data, train_data_labels, validation_data_labels = train_test_split(train1_data, train1_data_labels, test_size=0.33, random_state=1)


train_data = data_sq.iloc[:850,:]
train_data_labels = df.iloc[:850,:]

validation_data = data_sq.iloc[850:1050,:]
validation_data_labels = df.iloc[850:1050,:]
...
validation_data_labels = le.transform(np.ravel(validation_data_labels))
